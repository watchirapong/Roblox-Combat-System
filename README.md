...
| Server: `มานาไม่พอ` | มานาไม่เพียงพอ | รอให้มานาเพิ่ม หรือตั้ง `UseMana = false` |
...
["HeavyStrike"] = {
	...
	ManaCost = 15,                -- มานาที่ใช้ (ถ้า UseMana = true)
	CastTime = 0.2,
	VFXId = "rbxassetid://0",
...
- มานาเพิ่มอัตโนมัติ ~0.05 ต่อวินาที แก้ได้ที่ `CombatHandler.lua` บรรทัด `setMana(plr, cur + 0.05)`
