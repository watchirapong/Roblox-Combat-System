...
| `ผู้เล่นน้อยกว่า 2 คน` | เล่นคนเดียว (ก่อนมี Dummy) | ไม่สำคัญ — ตอนนี้รองรับ Dummy แล้ว |
| `ไม่มีศัตรูในระยะ X studs` | ศัตรู/Dummy อยู่ไกลเกินไป | เดินเข้าไปให้ใกล้ Dummy หรือผู้เล่นอื่น (ภายใน Range) |
| `มีสกิลแต่ไม่มีเป้า` | ไม่มีเป้าในระยะ | เดินเข้าใกล้ Dummy หรือผู้เล่น — ต้องอยู่ใน Range ของสกิล |
